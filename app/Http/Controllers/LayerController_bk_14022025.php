...
use App\Models\{Layer,LayersDetails, User};
use DB;
use Auth;
...
class LayerController extends Controller
{
    ...
    public function getCompanyLayers(Request $request){
        $layerSettings = User::select('general_settings')->where('id', Auth::user()->id)->first();
        $layersData = json_decode($layerSettings->general_settings)?->layer_settings?->layers;
