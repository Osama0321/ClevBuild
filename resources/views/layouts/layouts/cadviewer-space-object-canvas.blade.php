...
<tbody>
	...
	<td border="1px">
		<div id="device_drag">
	  <img src="../content/drawings/svg/device_54.svg" alt="CADViewer insert Object" width="40px" onClick="selectIconImage(1)"/>
		</div>
	</td>
	</tr>
	...
	<td> 
		<div id="wifi_drag">
		  <img src="../content/drawings/svg/wifi_25.svg" alt="CADViewer insert Object" width="40px"  onClick="selectIconImage(2)"/>
		</div>
	</td>
	</tr>
	...
	<td>
		<div id="pin_drag">
		<img src="../content/drawings/svg/pin_01.svg" alt="CADViewer insert Object"  width="40px" height="40px" onClick="selectIconImage(3)"/> 
		</div>
	</td>
	</tr>
	<tr>
	<td>
		<div id="aircon_drag">
	  <img src="../content/drawings/svg/HVAC_04.svg" alt="CADViewer insert Object"  width="40px"  onClick="selectIconImage(4)"/>
		</div>
	</td>
	</tr>
	...
	<td>
		<div id="boiler_drag">
	  <img src="../content/drawings/svg/HVAC_01.svg" alt="CADViewer insert Object"  width="40px" onClick="selectIconImage(5)"/>
		</div>
	</td>
	</tr>
	...
	<td>
		<div id="vent_drag">
	  <img src="../content/drawings/svg/HVAC_02.svg" alt="CADViewer insert Object"  width="40px" onClick="selectIconImage(6)"/>
		</div>
	</td>
	</tr>
	...
	<td>
		<div id="temp_drag">
	  <img src="../content/drawings/svg/HVAC_03.svg" alt="CADViewer insert Object"  width="40px" onClick="selectIconImage(7)"/>
		</div>
	</td>
	</tr>
	...
	<td>
		<div id="assembly_drag">
			<img src="../content/drawings/svg/assembly_point.png" alt="CADViewer insert Object"  width="40px" onClick="selectIconImage(8)"/>
		</div>
	</td>
	</tr>
	...
	<td>
		<div id="danger_drag">
			<img src="../content/drawings/svg/danger.png" alt="CADViewer insert Object"  width="40px" onClick="selectIconImage(9)"/>
		</div>
	</td>
	</tr>
	...
	<td>
		<div id="fire_alarm_drag">
			<img src="../content/drawings/svg/fire_alarm_call_point.png" alt="CADViewer insert Object"  width="40px" onClick="selectIconImage(10)"/>
		</div>
	</td>
    </tr>
	...
	<td>
		<div id="fire_exit_drag">
			<img src="../content/drawings/svg/fire_exit.png" alt="CADViewer insert Object"  width="40px" onClick="selectIconImage(11)"/>
		</div>
	</td>
	</tr>
	...
	<td>
		<div id="fire_extinguisher_drag">
			<img src="../content/drawings/svg/fire_extinguisher.png" alt="CADViewer insert Object"  width="40px" onClick="selectIconImage(12)"/>
		</div>
	</td>
    </tr>
	...
	<td>
		<div id="refuge_point_drag">
			<img src="../content/drawings/svg/refuge_point.png" alt="CADViewer insert Object"  width="40px" onClick="selectIconImage(13)"/>
		</div>
	</td>
    </tr>
