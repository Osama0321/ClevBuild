@extends('layouts.admin.app', ['title' => 'Global Layer Settings'])
            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-header">
                        <h2 class="text-center mb-4">Global Layer Settings</h2>
                        @empty($layersListing)
                    ...
                    <div class="card-body">
                        <!-- Layer settings table -->
                        <div id="layer-settings" class="d-none">
...
<script type="text/javascript">
    ...
    function renderLayers() {
        ...
        if (layerData.length > 0) {
            // document.getElementById('no-layers-msg').classList.add('d-none');
            document.getElementById('layer-settings').classList.remove('d-none');
        }
        ...
        // }
        // else {
        //     document.getElementById('no-layers-msg').classList.remove('d-none');
        //     document.getElementById('layer-settings').classList.add('d-none');
        // }
    }
    ...
    document.getElementById('layer-management-modal').addEventListener('click', function (e) {
        ...
        // if (e.target.closest('cancel-btn') || e.target.closest('modal-close-btn')) {
    ...
    document.getElementById('update-settings-btn').addEventListener('click', function() {
        ...
        if (confirmation) {
            ...
            formData.append("layerData", layerData);
            formData.append("_token", document.querySelector('meta[name="csrf-token"]').getAttribute("content"));
    ...
    document.getElementById("replace-layers-btn").addEventListener("click", function (e) {
        
        const confirmation = window.confirm("Are you sure you want to replace the layers?");
    ...
    // document.getElementById('import-dwg-form').addEventListener('submit', function(e) {
    //     e.preventDefault();
    ...
    //     formData.append('company_id', '123'); // Example company ID

    //     // Simulate AJAX request
    //     document.getElementById('import-dwg-btn').textContent = 'Processing...';
    //     setTimeout(() => {
    //         // Simulate server response
    //         const importedLayers = [
    //             { name: "Imported Layer 1", type: "pipe", lock: false, hide: false },
    //             { name: "Imported Layer 2", type: "head", lock: true, hide: false }
    //         ];

    //         const append = confirm("Do you want to append imported layers to existing layers?");
    //         if (append) {
    //             layerData = layerData.concat(importedLayers);
    //         } else {
    //             layerData = importedLayers;
    //         }

    //         resetLayerTable();
    //         document.getElementById('import-dwg-btn').textContent = 'Import from DWG';
    //         alert('Layers imported successfully!');
    //     }, 2000);
    // });
