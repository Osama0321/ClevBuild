        ...
        <div class="content-header">
            <div class="container-fluid">
                ...
                <div class="card card-primary">
                    ...
                    <form id="form" action="{{route('companies.store')}}" method="POST" autocomplete="off">
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="phone_no" class="form-control" id="PhoneNo" placeholder="Enter Phone" value="{{ old('phone_no') }}" oninput="validatePhoneNumber(this)">
                                    </div>
                                </div>
                            </div>
                        </div>
