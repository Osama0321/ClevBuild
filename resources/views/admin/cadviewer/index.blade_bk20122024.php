    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button id="updateTasks" type="button" class="btn btn-primary">Update</button>
            </div>
        </div>
    </div>
</div>
...
<div class="task_section">
	...
	<div class="tasks_btns_wrapper">
		<div class="tasks_btns_inner">
			<button type="button" data-toggle="modal" data-target="#allTaskModal">All Tasks</button>
			<button type="button" data-toggle="modal" data-target="#CompletedTaskModal">Completed Tasks</button>
			<button type="button" data-toggle="modal" data-target="#PendingTaskModal">Pending Tasks</button>
		</div>
		<div class="tasks_btns_inner">
